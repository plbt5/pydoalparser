...
class Transformation():
    ...
    def registerLocalMethod(self, python_module=None, method_name=None):
        ...
        Todo: this function is defined very very specific for one module only, i.e., unitconversion.py. Generalisation is required for this to work properly.
        '''
        ...
        if len(mod_split) == 1:
            # TODO: Include parsing submodules; now only module.py are accepted
            python_module += ".py"
...
#             from mediator.EDOALparser import Context
            # I commented this line out, and the one 12 lines down (assert isinstance() ) because: 
            #     1: there is NO Context defined in mediator.EDALparser, and 
            #     2. this is weird use of sparql definitions where sparql queries do not apply. 
            #    It should only parse and register the particular data transformation function to use
            # TODO: Potential issue here. Add tests and validate proper function registration
            '''
            ...
            # I commented this line out, and the import for Context 12 lines up because: 
            #     1: there is NO Context defined in mediator.EDALparser, and 
            #     2. this is weird use of sparql definitions where sparql queries do not apply. 
            #    It should only parse and register the particular data transformation function to use
